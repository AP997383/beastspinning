package com.adolfoponce.spinning.utils.ui.tiket
...
class TicketViewHistory  @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    init {
        ...
        try {
            circleRadius = a.getDimension(R.styleable.TicketViewx_tv_circleRadius, getDp(DEFAULT_RADIUS).toFloat())
            anchorViewId1 = a.getResourceId(R.styleable.TicketViewx_tv_anchor1, NO_VALUE)
            anchorViewId2 = a.getResourceId(R.styleable.TicketViewx_tv_anchor2, NO_VALUE)
            circleSpace = a.getDimension(R.styleable.TicketViewx_tv_circleSpace, getDp(15f).toFloat())
            dashColor = a.getColor(R.styleable.TicketViewx_tv_dashColor, Color.parseColor("#0085be"))
            dashSize = a.getDimension(R.styleable.TicketViewx_tv_dashSize, getDp(1.5f).toFloat())
        } finally {
            a.recycle()
        }
