package com.adolfoponce.spinning.utils.ui.carrousel.listener
...
interface CarouselListener {
     ...
     */
    fun onBindViewHolder(binding: ViewBinding, item: Any, position: Int) {}
     ...
     */
    fun onClick(position: Int, carouselItem: Any) {}
     ...
     */
    fun onLongClick(position: Int, carouselItem: Any) {}
}
