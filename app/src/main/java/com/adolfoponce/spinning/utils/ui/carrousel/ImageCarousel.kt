package com.adolfoponce.spinning.utils.ui.carrousel
...
import com.adolfoponce.spinning.utils.ui.carrousel.adapter.FiniteCarouselAdapter
import com.adolfoponce.spinning.utils.ui.carrousel.adapter.InfiniteCarouselAdapter
import com.adolfoponce.spinning.utils.ui.carrousel.listener.CarouselListener
import com.adolfoponce.spinning.utils.ui.carrousel.listener.CarouselOnScrollListener
...
import com.adolfoponce.spinning.utils.ui.carrousel.utils.CarouselLinearLayoutManager
import com.adolfoponce.spinning.utils.ui.carrousel.utils.LinearStartSnapHelper
import com.adolfoponce.spinning.utils.ui.carrousel.utils.dpToPx
import com.adolfoponce.spinning.utils.ui.carrousel.utils.getSnapPosition
import com.adolfoponce.spinning.utils.ui.carrousel.utils.spToPx
...
class ImageCarousel(
        ...
        recyclerView.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (showCaption && currentRealPosition >= 0) {
                    if(adapter?.getItem(currentRealPosition) is CarouselItem) {
                        dataItem = adapter?.getItem(currentRealPosition) as CarouselItem
    ...
    @JvmName("setData1")
    fun setData(data: List<DayMontWeekModel>) {
        adapter?.apply {
            replaceData(data)
