...
import com.adolfoponce.spinning.databinding.ItemCarouselBinding
...
import com.adolfoponce.spinning.utils.ui.carrousel.utils.CarouselItemDecoration
import com.adolfoponce.spinning.utils.ui.carrousel.utils.setImage
...
open class FiniteCarouselAdapter(
    ...
    protected val dataList: MutableList<Any> = mutableListOf()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (autoWidthFixing && carouselType == CarouselType.SHOWCASE) {
            ...
            if (holder.itemView.layoutParams.width >= 0 &&
                ...
                holder.itemView.layoutParams.width = (containerWidth / 3) + 1
            }
        }
    ...
    fun replaceData(newDataList: List<Any>): List<Any> {
        this.dataList.clear()
     ...
     */
    fun appendData(newDataList: List<CarouselItem>): List<Any> {
     ...
     */
    fun appendData(item: Any): List<Any> {
