...
public class CircularProgressIndicator extends View {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textColor = a.getColor(R.styleable.CircularProgressIndicator_textColorindicator, progressColor);
            textSize = a.getDimensionPixelSize(R.styleable.CircularProgressIndicator_textSizeindicator, textSize);
